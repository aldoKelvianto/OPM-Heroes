...
object QuoteDatabase {
    ...
    private val quoteList: List<Quote> by lazy {
        listOf(
                ...
                Quote("Saitama", "I'm not a hero because I want your approval. I do it because I want to!"),
                Quote("Saitama", "I'm just a guy who's a hero for fun"),
                ...
                Quote("Sweet Mask", "A hero must be tough, strong and beautiful... As well as able to promptly and splendidly eradicate evil."),

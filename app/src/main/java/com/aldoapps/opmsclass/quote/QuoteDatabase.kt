...
object QuoteDatabase {
    ...
    private val quoteList: List<Quote> by lazy {
        listOf(
                ...
                Quote("Saitama", "I'm not a heroListEntity because I want your approval. I do it because I want to!"),
                Quote("Saitama", "I'm just a guy who's a heroListEntity for fun"),
                ...
                Quote("Sweet Mask", "A heroListEntity must be tough, strong and beautiful... As well as able to promptly and splendidly eradicate evil."),

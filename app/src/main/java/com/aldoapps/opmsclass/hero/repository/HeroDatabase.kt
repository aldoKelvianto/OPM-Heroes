...
object HeroDatabase {
    ...
    init {
        ...
        HERO_ENTITY_LIST["Watchdog Man"] = HeroEntity("Watchdog Man", "Watchdog Man", R.drawable.ic_watchdog_man, 12, "Eggman")
        HERO_ENTITY_LIST["Genos"] = HeroEntity("Genos", "Demon Cyborg", R.drawable.ic_genos, 14, "History's strongest disciple")
        HERO_ENTITY_LIST["Tanktop Master"] = HeroEntity("Tanktop Master", "Tanktop Master", R.drawable.ic_tanktop_master, 15, "TTM")
        HERO_ENTITY_LIST["Bad"] = HeroEntity("Bad", "Metal Bat", R.drawable.ic_bad, 16, "If Hulk is a Japanese")
        HERO_ENTITY_LIST["Puri-puri Prisoner"] = HeroEntity("Puri-puri Prisoner", "Puri-puri Prisoner", R.drawable.ic_puripuri_purisoner, 17, "Eggman")
